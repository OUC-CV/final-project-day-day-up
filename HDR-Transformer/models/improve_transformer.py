...
from models.innovate import Change
...
class UpsampleOneStep(nn.Sequential):
    ...
    def __init__(self, scale, num_feat, num_out_ch, input_resolution=None):
        ...
        self.input_resolution = input_resolution
        m = []
        m.append(nn.Conv2d(num_feat, num_out_ch, 3, 1, 1))
...
class HDRTransformer(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.conv_first = Mlp(embed_dim, embed_dim, act_layer=nn.GELU, drop=drop_rate)
...
if __name__ == '__main__':
    upscale = 4
    window_size = 8
    height = 128 #(128 // upscale // window_size + 1) * window_size
    width = 128 #(128 // upscale // window_size + 1) * window_size
    model = HDRTransformer(upscale=2, img_size=(height, width), in_chans=18,
