...
from models.hdr_transformer import SCTNet
from utils.utils import *


#sig17_training_crop128_stride64
def get_args():
    parser = argparse.ArgumentParser(description='args',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("--network", type=str, default='HDR_Transformer',
                        help='Network to train'),
    parser.add_argument("--dataset_dir", type=str, default='D:\code\Vision\datas',
                        help='dataset directory'),
    parser.add_argument('--patch_size', type=int, default=128),
    parser.add_argument("--sub_set", type=str, default='sig17_training_crop128_stride64',
                        help='dataset directory')
    parser.add_argument('--logdir', type=str, default='./ckpt_transformer',
    ...
    parser.add_argument('--batch_size', type=int, default=22, metavar='N',
...
def main():
    ...
    # model architectures
    print(f'Selected network: {args.network}')
    upscale = 4
    window_size = 8
    ...
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers,
                              pin_memory=True)
    print("train_loader over",train_loader)
    ...
    print(f'''===> Start training HDR_Transformer
